...
plot "../eos.hadron.sly4/sly4.dat.NUC.csv" using 1:2 with lines lt rgb "blue" title "Sly4", \
...
plot "../eos.hadron.sly4/sly4.dat.NUC.csv" using 2:1 with lines lt rgb "blue" title "Sly4", \
...
plot "../eos.hadron.sly4/sly4.dat.NUC.csv" using 4:2 with lines lt rgb "blue" title "Sly4", \
...
plot "../eos.hadron.sly4/sly4.dat.NUC.csv" using 4:3 with lines lt rgb "blue" title "Sly4", \
