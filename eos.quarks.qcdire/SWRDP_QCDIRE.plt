...
set output "./eos_SWRDP_QCDIRE.eps"
...
set title 'SWRDP e QCDIRE, {/Symbol e} {/Symbol \264} P' font ",14"
...
plot "qcd.ire.eos.uds_2.NUC.csv" using @columns ls 10 title "QCDIRE", \
     "../eos.hadron.swrdp/eos_swrdp_l0040_L97a32.csv" using @columns_swrdp ls 4 title "{/Symbol z}=0.040", \
     "../eos.hadron.swrdp/eos_swrdp_l0049_L97a32.csv" using @columns_swrdp ls 4 title "{/Symbol z}=0.049", \
     "../eos.hadron.swrdp/eos_swrdp_l0059_L97a32.csv" using @columns_swrdp ls 4 title "{/Symbol z}=0.059", \
     "../eos.hadron.swrdp/eos_swrdp_l0071_L97a32.csv" using @columns_swrdp ls 4 title "{/Symbol z}=0.071", \
     "../eos.hadron.swrdp/eos_swrdp_l0085_L97a32.csv" using @columns_swrdp ls 4 title "{/Symbol z}=0.085", \
