...
plot "../eos.hadron.rosana/EoS_Rosana01_completo.csv" using 1:2 with lines lt rgb "blue" title "Rosana_1", \
...
plot "../eos.hadron.rosana/EoS_Rosana01_completo.csv" using 2:1 with lines lt rgb "blue" title "Rosana_1", \
...
plot "../eos.hadron.rosana/EoS_Rosana01_completo.csv" using 4:2 with lines lt rgb "blue" title "Rosana_1", \
...
plot "../eos.hadron.rosana/EoS_Rosana01_completo.csv" using 4:3 with lines lt rgb "blue" title "Rosana 1", \
