...
SWRDP='"../../../eos.hadron.swrdp/eos_swrdp_l0085_L97a32.csv"'
ZETA='0.085'
...
set output "./swrdp_85_TODAS_MFTQCD.eps"
...
set title 'SWRDP, {/Symbol z}=0.085 - MFTQCD, {/Symbol m} {/Symbol \264} P'
...
plot @SWRDP using @columns ls 10 title "SWRDP - {/Symbol z}=0.085", \
...
set output "./swrdp_85_MAXWELL_MFTQCD.eps"
