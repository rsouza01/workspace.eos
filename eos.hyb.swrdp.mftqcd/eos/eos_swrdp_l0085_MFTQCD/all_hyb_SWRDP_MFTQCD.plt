...
set output "./hyb_SWRDP_85_energy_pressure_MFTQCD.eps"
...
set title 'BPS + SWRDP({/Symbol z}=0.085) + MFTQCD(B_{QCD}=90 MeV/fm^{3}), {/Symbol e} {/Symbol \264} P'
set xlabel '{/Symbol e} [MeV fm^{-3}]'
set ylabel 'Pressure [MeV fm^{-3}]'

columns="1:2"

plot "./eos.HYB.SWRDP_0085-MFTQCD_B90_XI_00040.NUC.csv" using @columns ls 1 title "{/Symbol x}=0.00040", \
     "./eos.HYB.SWRDP_0085-MFTQCD_B90_XI_00050.NUC.csv" using @columns ls 2 title "{/Symbol x}=0.00050", \
...
set output "./hyb_SWRDP_85_pressure_energy_MFTQCD.eps"
...
set title 'BPS + SWRDP({/Symbol z}=0.0085) + MFTQCD(B_{QCD}=90 MeV/fm^{3}), P  {/Symbol \264} {/Symbol e}'
...
set output "./hyb_SWRDP_85_mu_pressure_MFTQCD.eps"
...
plot "./eos.HYB.SWRDP_0085-MFTQCD_B90_XI_00040.NUC.csv" using @columns ls 1 title "{/Symbol z}=0.0085, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00040", \
     "./eos.HYB.SWRDP_0085-MFTQCD_B90_XI_00050.NUC.csv" using @columns ls 2 title "{/Symbol z}=0.0085, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00050", \
