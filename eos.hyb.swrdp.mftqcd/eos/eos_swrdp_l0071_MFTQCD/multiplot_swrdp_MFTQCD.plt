...
SWRDP='"../../../eos.hadron.swrdp/eos_swrdp_l0071_L97a32.csv"'
ZETA='0.071'
...
set output "./swrdp_71_TODAS_MFTQCD.eps"
...
set title 'SWRDP, {/Symbol z}=0.071 - MFTQCD, {/Symbol m} {/Symbol \264} P'
...
plot @SWRDP using @columns ls 10 title "SWRDP - {/Symbol z}=0.071", \
...
set output "./swrdp_71_MAXWELL_MFTQCD.eps"
