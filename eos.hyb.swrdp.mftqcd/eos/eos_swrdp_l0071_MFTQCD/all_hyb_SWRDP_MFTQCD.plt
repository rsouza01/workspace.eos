...
set output "./hyb_SWRDP_71_energy_pressure_MFTQCD.eps"
...
set title 'BPS + SWRDP({/Symbol z}=0.071) + MFTQCD(B_{QCD}=90 MeV/fm^{3}), {/Symbol e} {/Symbol \264} P'
set xlabel '{/Symbol e} [MeV fm^{-3}]'
set ylabel 'Pressure [MeV fm^{-3}]'

columns="1:2"

plot "./eos.HYB.SWRDP_0071-MFTQCD_B90_XI_00040.NUC.csv" using @columns ls 1 title "{/Symbol x}=0.00040", \
     "./eos.HYB.SWRDP_0071-MFTQCD_B90_XI_00050.NUC.csv" using @columns ls 2 title "{/Symbol x}=0.00050", \
     "./eos.HYB.SWRDP_0071-MFTQCD_B90_XI_00070.NUC.csv" using @columns ls 3 title "{/Symbol x}=0.00070", \
...
set output "./hyb_SWRDP_71_pressure_energy_MFTQCD.eps"
...
plot "./eos.HYB.SWRDP_0071-MFTQCD_B90_XI_00040.NUC.csv" using @columns ls 1 title "{/Symbol z}=0.0071, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00040", \
     "./eos.HYB.SWRDP_0071-MFTQCD_B90_XI_00050.NUC.csv" using @columns ls 2 title "{/Symbol z}=0.0071, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00050", \
     "./eos.HYB.SWRDP_0071-MFTQCD_B90_XI_00070.NUC.csv" using @columns ls 3 title "{/Symbol z}=0.0071, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00070", \

#---------------------------------------------------------------------------------------------------
#PLOT 3 - TODAS EOS - mu x pressure
#---------------------------------------------------------------------------------------------------

set output "./hyb_SWRDP_71_mu_pressure_MFTQCD.eps"
