...
set output "./hyb_SWRDP_59_energy_pressure_MFTQCD.eps"
...
set title 'BPS + SWRDP({/Symbol z}=0.059) + MFTQCD(B_{QCD}=90 MeV/fm^{3}), {/Symbol e} {/Symbol \264} P'
set xlabel '{/Symbol e} [MeV fm^{-3}]'
set ylabel 'Pressure [MeV fm^{-3}]'

columns="1:2"

plot "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00040.NUC.csv" using @columns ls 1 title "{/Symbol x}=0.00040", \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00050.NUC.csv" using @columns ls 2 title "{/Symbol x}=0.00050", \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00070.NUC.csv" using @columns ls 3 title "{/Symbol x}=0.00070", \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00090.NUC.csv" using @columns ls 4 title "{/Symbol x}=0.00090", \
...
set output "./hyb_SWRDP_59_pressure_energy_MFTQCD.eps"
...
plot "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00040.NUC.csv" using @columns ls 1 title "{/Symbol z}=0.0059, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00040", \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00050.NUC.csv" using @columns ls 2 title "{/Symbol z}=0.0059, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00050", \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00070.NUC.csv" using @columns ls 3 title "{/Symbol z}=0.0059, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00070", \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00090.NUC.csv" using @columns ls 4 title "{/Symbol z}=0.0059, B_{QCD}=90 MeV/fm^{3}, {/Symbol x}=0.00090", \

#---------------------------------------------------------------------------------------------------
#PLOT 3 - TODAS EOS - mu x pressure
#---------------------------------------------------------------------------------------------------

set output "./hyb_SWRDP_59_mu_pressure_MFTQCD.eps"
