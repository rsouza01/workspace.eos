...
#HADRON EOS
EOS_HADRON_PREFIX="SWRDP_0040"
EOS_HADRON_INPUT_DIR=../eos.hadron.swrdp/
EOS_HADRON_FILE=${EOS_HADRON_INPUT_DIR}eos_swrdp_l0040_L97a32.csv


#QUARK EOS
EOS_QUARK_PREFIX="MFTQCD_B90_XI"
EOS_MFTQCD_XI_VALUES=(00100 00090 00070 00050)

#EOS_MFTQCD_XI_VALUES=(00100)

EOS_QUARK_INPUT_DIR=../eos.quarks.mftqcd/
...
do
    ...
    ${MAXWELL_CONSTR} --config=${PROP_FILE} --quarks=${EOS_INPUT_QUARK_FILE} --hadrons=${EOS_HADRON_FILE} --mu_0=1300 > ./${OUT_FILE_NAME}
