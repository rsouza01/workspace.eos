...
set output "./hyb_SWRDP_40_energy_pressure_MFTQCD.eps"
...
set title 'BPS + SWRDP({/Symbol z}=0.040) + MFTQCD(B_{QCD}=90 MeV/fm^{3}), {/Symbol e} {/Symbol \264} P'
set xlabel '{/Symbol e} [MeV fm^{-3}]'
set ylabel 'Pressure [MeV fm^{-3}]'

columns="1:2"

plot "./eos.HYB.SWRDP_0040-MFTQCD_B90_XI_00050.NUC.csv" using @columns ls 1 title "{/Symbol x}=0.00050", \
     "./eos.HYB.SWRDP_0040-MFTQCD_B90_XI_00070.NUC.csv" using @columns ls 2 title "{/Symbol x}=0.00070", \
     "./eos.HYB.SWRDP_0040-MFTQCD_B90_XI_00090.NUC.csv" using @columns ls 3 title "{/Symbol x}=0.00090", \
     "./eos.HYB.SWRDP_0040-MFTQCD_B90_XI_00100.NUC.csv" using @columns ls 4 title "{/Symbol x}=0.00100", \
...
set output "./hyb_SWRDP_40_pressure_energy_MFTQCD.eps"
...
set title 'BPS + SWRDP({/Symbol z}=0.040) + MFTQCD(B_{QCD}=90 MeV/fm^{3}), P  {/Symbol \264} {/Symbol e}'
...
set output "./hyb_SWRDP_40_mu_pressure_MFTQCD.eps"
...
set title 'BPS + SWRDP({/Symbol z}=0.040) + MFTQCD(B_{QCD}=90 MeV/fm^{3}), {/Symbol m} {/Symbol \264} P'
