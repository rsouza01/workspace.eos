...
plot "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00040.NUC.csv" using @columns ls 1, \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00050.NUC.csv" using @columns ls 2, \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00070.NUC.csv" using @columns ls 3, \
     "./eos.HYB.SWRDP_0059-MFTQCD_B90_XI_00090.NUC.csv" using @columns ls 4, \
