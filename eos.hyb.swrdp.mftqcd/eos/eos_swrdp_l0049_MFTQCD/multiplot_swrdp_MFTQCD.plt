...
set output "./swrdp_49_TODAS_MFTQCD.eps"
...
set title 'SWRDP, {/Symbol z}=0.049 - MFTQCD, {/Symbol m} {/Symbol \264} P'
...
plot @SWRDP using @columns ls 10 title "SWRDP - {/Symbol z}=0.049", \
...
set output "./swrdp_49_MAXWELL_MFTQCD.eps"
